...
st.image("https://raw.githubusercontent.com/AnkurK07/Recommender-System/main/output-onlinegiftools1.gif", width=1400 )
...
X = pd.DataFrame(recommendations, columns=[" Top 5 Recommended Movies"])
